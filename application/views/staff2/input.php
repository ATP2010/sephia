...
<table id="example1" class="table table-bordered table-hover">
  ...
  <tbody>
      ...
      ?>
        ...
        <td>
        	<?php echo anchor('staff/done/'.$row->id, 'execute');?>
          <!--<?php echo anchor('staff/delete/'.$row->id, 'Delete', array('onclick'=>"return confirm('Hapus data ini?')"));?>-->
        </td>
      </tr>
      <?php }?>
  </tbody>
</table>
<div class="box-footer"><button id="btnExport" class="btn btn-info pull-left">Export to excel</button></div>
</div>
</div>
</section>
