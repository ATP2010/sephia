  ...
  <body class="bgform">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?=base_url();?>"><b><font color="white">Se</b>Phia</font></a>
      <br/>
        <small><font color="white">CC <b>147</b> SEMARANG</font></small>
      </div><!-- /.login-logo -->
      
      <div class="login-box-body">
        <p class="login-box-msg"><font color="white">Login & Password sama seperti Mediasel.</font></p>
        <form action="<?=base_url('web/login');?>" method="post" onsubmit="return cekform();">
        ...
        <a href="" onclick="alert('Hubungi INFRATEL !');"><font color="white">Lupa Password?</a><br>
        <div class="social-auth-links text-center">
          <p><b><font color="white">infratel147smg &copy; 2015</font></b></p>
