            ...
            <a href="<?=base_url('agentc4');?>">
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="<?=base_url('agentc4/tiket_in');?>"><i class="fa fa-circle-o"></i> Tiket IN</a></li>
                <li class=""><a href="<?=base_url('agentc4/tiket_cb');?>"><i class="fa fa-circle-o"></i> Tiket Callback</a></li>
              </ul>
            </li>
