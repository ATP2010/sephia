        ...
        <ul class="sidebar-menu">
          ...
          <li>
            <a href="<?=base_url('agent');?>">
             ...
             <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class=""><a href="<?=base_url('agent/tiket_in');?>"><i class="fa fa-circle-o"></i> List data</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="<?=base_url('agent/create_hc');?>"><i class="fa fa-circle-o"></i> Input tiket HC</a></li>
                <li class=""><a href="<?=base_url('agent/list_hc');?>"><i class="fa fa-circle-o"></i> List tiket HC</a></li>
              </ul>
            </li>
