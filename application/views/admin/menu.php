        ...
        <ul class="sidebar-menu">
          ...
          <li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="<?=base_url('admin/tiket_hc_new');?>"><i class="fa fa-circle-o"></i> New Tiket</a></li>
                <li class=""><a href="<?=base_url('admin/tiket_hc_sup');?>"><i class="fa fa-circle-o"></i> Input DINA</a></li>
                <li class=""><a href="<?=base_url('admin/tiket_hc_tl');?>"><i class="fa fa-circle-o"></i> Posting TIAL</a></li>
                <li class=""><a href="<?=base_url('admin/tiket_hc_ok');?>"><i class="fa fa-circle-o"></i> Tiket Closed</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="<?=base_url('admin/data_hr');?>"><i class="fa fa-circle-o"></i> Report</a></li>
              </ul>
            </li>
